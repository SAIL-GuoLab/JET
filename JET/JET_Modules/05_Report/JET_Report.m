function JET_STR = JET_Report(JET_STR)
...
%saveas(h201,strcat(JET_STR.Report.report_dir,'/',JET_STR.Report.Subject_foldername,'_Fitting.png'))
saveas(h201, strcat(JET_STR.Report.report_dir, '/', JET_STR.Report.Subject_foldername, '_Fitting.png'))
...
%Spec_off(JET_STR.Loader.current_subject_folder_index,:)=OffSpecData;
%Spec_diff(JET_STR.Loader.current_subject_folder_index,:)=DiffSpecData                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   ;
...
GABA_Amplitude(JET_STR.Loader.current_subject_folder_index) = JET_STR.SF.fit.GABA;
Glx_Amplitude(JET_STR.Loader.current_subject_folder_index) = JET_STR.SF.fit.Glx;
Cr_Amplitude(JET_STR.Loader.current_subject_folder_index) = JET_STR.SF.fit.Cr;
Cho_Amplitude(JET_STR.Loader.current_subject_folder_index) = JET_STR.SF.fit.Cho;
NAA_Amplitude(JET_STR.Loader.current_subject_folder_index) = JET_STR.SF.fit.NAA;
GABA_GOF(JET_STR.Loader.current_subject_folder_index) = JET_STR.SF.fit.GABA_GOF;
Glx_GOF(JET_STR.Loader.current_subject_folder_index) = JET_STR.SF.fit.Glx_GOF;
Cr_GOF(JET_STR.Loader.current_subject_folder_index) = JET_STR.SF.fit.Cr_GOF;
Cho_GOF(JET_STR.Loader.current_subject_folder_index) = JET_STR.SF.fit.Cho_GOF;
NAA_GOF(JET_STR.Loader.current_subject_folder_index) = JET_STR.SF.fit.NAA_GOF;
Cr_FWHM(JET_STR.Loader.current_subject_folder_index) = DeltaHz_Cr;
NSDR_GABA(JET_STR.Loader.current_subject_folder_index) = JET_STR.SF.fit.NSDR_GABA / GABA_Amplitude(JET_STR.Loader.current_subject_folder_index);
NSDR_Glx(JET_STR.Loader.current_subject_folder_index) = JET_STR.SF.fit.NSDR_Glx / Glx_Amplitude(JET_STR.Loader.current_subject_folder_index);

%%
subject_name = JET_STR.Loader.subject_foldername_all(JET_STR.Loader.current_subject_folder_index).name;
table =[string(subject_name), string(GABA_Amplitude(JET_STR.Loader.current_subject_folder_index)), ...
    string(Glx_Amplitude(JET_STR.Loader.current_subject_folder_index)), string(Cr_Amplitude(JET_STR.Loader.current_subject_folder_index)), ...
    string(Cho_Amplitude(JET_STR.Loader.current_subject_folder_index)), string(NAA_Amplitude(JET_STR.Loader.current_subject_folder_index)), ...
    string(GABA_GOF(JET_STR.Loader.current_subject_folder_index)), string(Glx_GOF(JET_STR.Loader.current_subject_folder_index)), ...
    string(Cr_GOF(JET_STR.Loader.current_subject_folder_index)), string(Cho_GOF(JET_STR.Loader.current_subject_folder_index)), ...
    string(NAA_GOF(JET_STR.Loader.current_subject_folder_index)), string(Cr_FWHM(JET_STR.Loader.current_subject_folder_index)), ...
    string(NSDR_GABA(JET_STR.Loader.current_subject_folder_index)), string(NSDR_Glx(JET_STR.Loader.current_subject_folder_index))];
