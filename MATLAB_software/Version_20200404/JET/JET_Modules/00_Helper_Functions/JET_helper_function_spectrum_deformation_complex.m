...
% functions for them.
%
% Jia Guo (jg3400@columbia.edu).

function Spec_Deformed = JET_helper_function_spectrum_deformation_complex(x, time, Freq, FID_Orig, LS_mode)
...
Spec_Deformed = Spec_Deformed_complex(Freq);
