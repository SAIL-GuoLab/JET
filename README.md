...
- Contributors: Jochen Weber, MS; Emily Turner Wood, MD/PhD; Wafae Labriji; Vasile Stupar, PhD; Gregory Smith, PhD.
...
## User Manual
The user guide can be found in both [PDF](https://github.com/SAIL-GuoLab/JET/blob/master/Documentation/JET_1.0_UserManual.pdf) and in [PowerPoint](https://github.com/SAIL-GuoLab/JET/blob/master/Documentation/JET_1.0_UserManual.pptx). The **most comprehensive** details can be found in the [Technical White Paper](https://github.com/SAIL-GuoLab/JET/blob/master/Documentation/JET_1.0_TechnicalWhitePaper.pdf).
